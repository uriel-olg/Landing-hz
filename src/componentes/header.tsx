...
export default function Header() {
  ...
  const [activo, setActivo] = useState<
    "Servicios" | "Procesos" | "Tecnologias" | "Contacto" | "Home"
  >("Home");
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full border-b border-white/10 bg-[#09131e]/70 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        {/* Logo */}
        <a href="#home" className="flex items-center gap-3 transition-all scroll-smooth">
          <img
            src="/hz_logo.webp"
            alt="HZ Software"
        ...
        {/* Menú móvil */}
        {open && (
          <nav className="absolute right-6 top-24 flex w-64 z-1 flex-col gap-5 rounded-2xl border border-white/10 bg-[#09131e]/80 backdrop-blur-2xl p-6 md:hidden">
            <a
              href="#home"
            ...
            <a
              ...
              className="mt-2 rounded-xl bg-blue-600 py-3 font-semibold text-white transition text-center hover:bg-blue-500"
            >
              Contactanos
            </a>
          </nav>
