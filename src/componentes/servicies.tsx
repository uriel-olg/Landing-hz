const services = [
  ...
  },
  {
    ...
    img: "/support.png",
    desc: "Brindamos asistencia técnica para resolver problemas de hardware y software de forma remota o presencial.",
  },
  {
    title: "Optimización de Equipos",
    img: "/optimization.png",
    desc: "Mejoramos el rendimiento de computadoras y notebooks para que trabajen de forma rápida y estable.",
  },
  {
    title: "Mantenimiento",
    img: "/maintenance.png",
    desc: "Realizamos mantenimiento preventivo y correctivo para prolongar la vida útil de tus equipos.",
  },
  {
    title: "Actualización de Hardware y Software",
    img: "/update.png",
    desc: "Instalamos, configuramos y actualizamos componentes, sistemas operativos y aplicaciones.",
  },
];
